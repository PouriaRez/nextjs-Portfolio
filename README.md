...
Welcome to my personal portfolio repository! This project showcases my journey as a software engineering student and highlights my skills, projects, and accomplishments. The website is built with **Next.js**, **TypeScript**, and **React**, and is designed to be **interactive**, **responsive**, and a reflection of my growth as a developer.
